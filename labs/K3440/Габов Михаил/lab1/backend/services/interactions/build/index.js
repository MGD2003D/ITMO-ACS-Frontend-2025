...
function startServer() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const dbConnection = data_source_1.AppDataSource.initialize();
            console.log("Connecting to RabbitMQ...");
            const rabbitConnection = (0, rabbitmq_config_1.initRabbitMQ)(RABBITMQ_URL);
            yield Promise.all([dbConnection, rabbitConnection]);
